...
// BitSongBlockchainGenState creates the core parameters for genesis initialization for BitSong
// note that the pubkey input is this machines pubkey
func BitSongBlockchainGenState(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
...
// BitSongValidateGenesisState ensures that the genesis state obeys the expected invariants
// TODO: No validators are both bonded and jailed (#2088)
// TODO: Error if there is a duplicate validator (#1708)
// TODO: Ensure all state machine parameters are in genesis (#1704)
func BitSongValidateGenesisState(genesisState GenesisState) error {
...
// BitSongAppGenStateJSON returns genesis state with JSON
func BitSongBlockchainGenStateJSON(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
	appState json.RawMessage, err error) {
	// create the final app state
	genesisState, err := BitSongBlockchainGenState(cdc, genDoc, appGenTxs)
	if err != nil {
		return nil, err
	}
...
func NewDefaultGenesisAccount(addr sdk.AccAddress) GenesisAccount {
	...
	coins := sdk.Coins{
		sdk.NewCoin(assets.MicroBitSongDenom, sdk.NewInt(116280760).MulRaw(assets.MicroUnit)),
	}
