...
import (
	...
	app "github.com/BitSongOfficial/go-bitsong"
...
var DefaultNodeHome = os.ExpandEnv("$HOME/.bitsongd")
...
func main() {
	...
	executor := cli.PrepareBaseCmd(rootCmd, "BS", DefaultNodeHome)
...
func InitCmd(ctx *server.Context, cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			fmt.Printf("Initialized bitsongd configuration and bootstrapping files in %s...\n", viper.GetString(cli.HomeFlag))
			return nil
		},
	}
...
$ bitsongd add-genesis-account bitsong1tse7r2fadvlrrgau3pa0ss7cqh55wrv6y9alwh 1000btsg
`),
