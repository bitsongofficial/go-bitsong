...
```
bitsongdebug pubkey TZTQnfqOsi89SeoXVnIw+tnFJnr4X8qVC0U8AsEmFk4=
bitsongdebug pubkey 4D94D09DFA8EB22F3D49EA17567230FAD9C5267AF85FCA950B453C02C126164E
```
...
```
bitsongdebug tx <hex or base64 transaction>
```
...
If you run `bitsongdebug hack $HOME/.bitsongd` on that 
