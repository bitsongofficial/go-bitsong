...
* [Validator](validators/overview.md)
  * [Setup](validators/validator-setup.md)
...
* [Join a network](./join-testnet.md)
* [Deploy a testnet](./deploy-testnet.md)
* [Interacting with the network: CLI](./bitsongcli.md)
