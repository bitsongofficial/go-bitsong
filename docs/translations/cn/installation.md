...
本教程将详细说明如何在你的系统上安装`bitsongd`和`bitsongcli`。安装后，你可以作为[全节点](./join-mainnet.md)或是[验证人节点](./validators/validator-setup.md)加入到主网。
...
等`bitsongd`和`bitsongcli`可执行程序安装完之后，请检查:
