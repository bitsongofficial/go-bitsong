...
bitsongd tx nft sign-metadata --collection-id=1 --metadata-id=1 --from=validator --chain-id=test --keyring-backend=test -y --broadcast-mode=block
...
bitsongd tx nft update-metadata --collection-id=1 --metadata-id=1 --name="Punk11" --symbol="PUNK" --uri="https://punk.com/10" --seller-fee-basis-points=100 --creators=$(bitsongd keys show -a validator --keyring-backend=test) --creator-shares="10" --from=validator --chain-id=test --keyring-backend=test -y --broadcast-mode=block
bitsongd tx nft update-metadata-authority --collection-id=1 --metadata-id=1 --new-authority="bitsong13m350fvnk3s6y5n8ugxhmka277r0t7cw48ru47" --from=validator --chain-id=test --keyring-backend=test -y --broadcast-mode=block
bitsongd tx nft update-mint-authority --collection-id=1 --metadata-id=1 --new-authority="bitsong13m350fvnk3s6y5n8ugxhmka277r0t7cw48ru47" --from=validator --chain-id=test --keyring-backend=test -y --broadcast-mode=block
