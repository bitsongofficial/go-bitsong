...
# bitsongd tx liquidity withdraw 1 1000poolE4D2617BFE03E1146F6BBA1D9893F2B3D77BA29E7ED532BB721A39FF1ECC1B07 --home ./data/localnet --chain-id localnet --from user1 --keyring-backend test --yes
...
# bitsongd q liquidity withdraw 1 --home ./data/localnet --output json | jq
...
# Ensure the existence of the liquidity pool. 
# If there is no liquidity pool created then use create-pool script to create liquidity pool.
# bitsongd tx liquidity withdraw 1 500pool4718822520A46E7F657C051A7A18A9E8857D2FB47466C9AD81CE2F5F80C61BCC --home ./data/localnet --chain-id localnet --from user1 --keyring-backend test --yes
...
# bitsongd q liquidity withdraws 1 --home ./data/localnet --output json | jq
echo "-> Querying liquidity withdrawals..."
