...
var (
	...
	ErrNotWinningBid               = sdkerrors.Register(ModuleName, 12, "not a winning winning bid")
	ErrInvalidNftId                = sdkerrors.Register(ModuleName, 13, "invalid nft id")
	ErrInvalidInstantSalePrice     = sdkerrors.Register(ModuleName, 14, "invalid instant sale price")
	ErrInvalidDuration             = sdkerrors.Register(ModuleName, 15, "invalid duration")
	ErrInvalidPrizeType            = sdkerrors.Register(ModuleName, 16, "invalid prize type")
	ErrInvalidAuctionId            = sdkerrors.Register(ModuleName, 16, "invalid auction id")
)
