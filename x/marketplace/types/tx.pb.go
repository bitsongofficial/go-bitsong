...
type MsgCreateAuction struct {
	...
	EndAuctionAt *time.Time `protobuf:"bytes,3,opt,name=end_auction_at,json=endAuctionAt,proto3,stdtime" json:"end_auction_at,omitempty"`
	/// Gap time is the amount of time in slots after the previous bid at which
	/// the auction ends.
	EndAuctionGap *time.Duration `protobuf:"bytes,4,opt,name=end_auction_gap,json=endAuctionGap,proto3,stdduration" json:"end_auction_gap,omitempty"`
	/// Minimum price for any bid to meet.
	PriceFloor uint64 `protobuf:"varint,5,opt,name=price_floor,json=priceFloor,proto3" json:"price_floor,omitempty"`
	/// Tick size
	TickSize uint64 `protobuf:"varint,6,opt,name=tick_size,json=tickSize,proto3" json:"tick_size,omitempty"`
	/// gap_tick_size_percentage - two decimal points
	GapTickSizePercentage uint32 `protobuf:"varint,7,opt,name=gap_tick_size_percentage,json=gapTickSizePercentage,proto3" json:"gap_tick_size_percentage,omitempty"`
}
...
var fileDescriptor_5bb3e9142747d703 = []byte{
	...
	,
}
...
func (m *MsgCreateAuction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GapTickSizePercentage != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.GapTickSizePercentage))
		i--
		dAtA[i] = 0x38
	}
	if m.TickSize != 0 {
	...
	if m.EndAuctionGap != nil {
		n1, err1 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.EndAuctionGap, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.EndAuctionGap):])
		if err1 != nil {
			return 0, err1
		}
		i -= n1
	...
	if m.EndAuctionAt != nil {
		n2, err2 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.EndAuctionAt, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.EndAuctionAt):])
		if err2 != nil {
			return 0, err2
		}
		i -= n2
...
func (m *MsgCreateAuction) Size() (n int) {
	...
	if m.GapTickSizePercentage != 0 {
		n += 1 + sovTx(uint64(m.GapTickSizePercentage))
	}
	return n
}
