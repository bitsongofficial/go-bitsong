...
import (
	...
	"github.com/bitsongofficial/bitsong/x/nft/exported"
)
...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(&MsgIssueDenom{}, "bitsong/nft/MsgIssueDenom", nil)
	cdc.RegisterConcrete(&MsgTransferNFT{}, "bitsong/nft/MsgTransferNFT", nil)
	cdc.RegisterConcrete(&MsgEditNFT{}, "bitsong/nft/MsgEditNFT", nil)
	cdc.RegisterConcrete(&MsgMintNFT{}, "bitsong/nft/MsgMintNFT", nil)
	cdc.RegisterConcrete(&MsgBurnNFT{}, "bitsong/nft/MsgBurnNFT", nil)

	cdc.RegisterInterface((*exported.NFT)(nil), nil)
	cdc.RegisterConcrete(&BaseNFT{}, "bitsong/nft/BaseNFT", nil)
}
