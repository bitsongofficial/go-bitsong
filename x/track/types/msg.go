...
func NewMsgTrackAdd(title string, artists, feat, producers, tags []string, genre, mood string,
	number, duration uint, explicit bool, extIds, extUrls map[string]string, pUrl string, dao Dao) MsgTrackAdd {
	return MsgTrackAdd{
		Title:        title,
		Artists:      artists,
		Producers:    producers,
